...
- Definition:
  - the count of saved weekly sessions where a user runs one client brief through at least two provider/persona paths and preserves the result in the application's conversation history or comparison flow
